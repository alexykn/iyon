...
The committed benchmark `packages/iyon-runtime/bench/PERF-11.1-generated-vertical-slice.json` was captured from clean source revision `0c1c2dd6a2fcd68bd8b8a052cc3d5a3026d4e7b5` under Bun `1.4.0`, revision `34cbb9a40b4bd1bd767d134a7065e66c2432a676`, with `fast-view-abi`, 1,000,000 warm/hot no-op/render-ref/ref-lookup iterations, and 10,000 semantic allocation/patch iterations. Native artifact SHA-256 is `65941058d8580b28e093e202c39f5feb46d25b5434fb3e0b490d963013a5731b`; schema BLAKE3 is `7fce882a8b31b7dab23c5515ffde2626513fed07f46366e3d9869a966fe1ccb1`; generator BLAKE3 is `6767bb7dce54c663ecaf7a84446e62ac37ca5f81733789e365918308bcee71b0`. Median nanoseconds per call were: `runtime_noop 9.771541`, `render_ref 15.444209`, `view_ref_for_node_id 37.22375`, `view_spacer_create 140.1209`, `view_text_layout_patch_root 285.3792`, and `view_common_patch_root 220.05`. The scalar benchmark writes zero structural transport bytes/records and records `structural_encoding_ns = 0`; these numbers are complete end-to-end call timings, not phase-subtracted claims.
