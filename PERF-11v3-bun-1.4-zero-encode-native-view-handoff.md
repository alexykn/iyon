...
Tranche 10 (`§22 PERF-11.8`) is implemented in commit `2b5632c5534139d2ce347fb9afee4bde4978d3e6` (`perf(tui): construct new View graphs through native builders`). The generated ABI now contains 39 functions and adds a disjoint `BuilderRef` range (`0x7ffe0001..0x7fff0001`) alongside the existing ViewRef, PathRef, and EditTxnRef ranges.
...
The end-to-end test is `packages/iyon-runtime/tests/tui_native_builder.test.ts`; native coverage is in `crates/iyon-native/src/tui/view_abi.rs` and generated ABI delegation/layout coverage is regenerated from the canonical schema. The clean Bun 1.4 benchmark is `packages/iyon-runtime/bench/PERF-11.8-native-builders.json`, captured at source revision `2b5632c5534139d2ce347fb9afee4bde4978d3e6` with `git_dirty: false`, Bun revision `34cbb9a40b4bd1bd767d134a7065e66c2432a676`, native artifact SHA-256 `1eddb258ef473de9b74a571d70773d863475715738075e4b430df31ad30f28a2`, schema BLAKE3 `823264c7f1539c872782879f296f3782e157960ece5969f64007bb7e5430d801`, and generator BLAKE3 `9c69e5f6b013b2655aa249b00601622b4d569cb6806fb25863e0d71fe93f53de`. With cold graphs of 20, 200, 2,000, and 10,000 spacer children, the generated route measured `24,912.5 ns`, `98,050 ns`, `873,486.3 ns`, and `5,768,375 ns`; the pre-materialized V4 control measured `40,191.6 ns`, `191,795.9 ns`, `2,024,889 ns`, and `11,704,667 ns`. The benchmark uses 2 warmups, 3 repeats, and an iteration policy of 10/3/1 for the respective size bands. These are full route timings including one host install; they are not phase-subtracted claims.
