...
Tranche 11 (`§22 PERF-11.9`) is implemented in commits `0771428`, `7894c55`, and `c8576b7` (`perf(tui): specialize Bun 1.4 string and style calls`, followed by fused text-layout recipe routing and native cstring-bound fixes). The canonical ABI now contains 46 functions and adds `StyleAtomRef`/`StyleRef` ranges, cstring style-atom creation, fixed scalar style creation, one-span length-preserving UTF-8 buffer creation, and cstring text constructors for one through four spans. All generated Rust/C/TypeScript bindings, manifests, layout tests, benchmark registry, and ABI reference are regenerated from the schema.
...
The clean Bun 1.4 string/style benchmark is `packages/iyon-runtime/bench/PERF-11.9-native-strings.json`, captured at source revision `c8576b71a0e6d6bf80720efb482bfa7267116070` with `git_dirty: false`, Bun revision `34cbb9a40b4bd1bd767d134a7065e66c2432a676`, native artifact SHA-256 `9768b86b63a5e076c25f0d4c2b8b5ae9201e992ce2c7c01811e0243aab9dfaa2`, schema BLAKE3 `2e4b86b766ff8db783e86905756b496e09f137e29bb0b36dc54dfa3834ebf809`, and generator BLAKE3 `a7337dcff858f38ae2b177f87758637fc2fcf2bb1d0ec1b1286722b66d00f0529`. With 2 warmups, 1,000 iterations, and 3 repeats, native versus V4 median nanoseconds were: short ASCII `2,225.083` vs `4,333.584`; short Unicode `1,823.583` vs `3,595.208`; embedded NUL `2,232` vs `3,156.333`; long text `2,662.417` vs `3,881.417`; styled chain `6,435.166` vs `7,741.583`; and one-to-four spans `2,590.625/3,125.625/2,668.5/2,569.916` vs `3,193.208/5,182/4,500.041/5,127.916`. Structural encoding, command words, path arrays, and NodeId arrays are zero for the native route. The benchmark includes FFI, native text/style construction, publication, and host installation; cstring transcoding is part of the measured total and is not claimed zero-cost.
