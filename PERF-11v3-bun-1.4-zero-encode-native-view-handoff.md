...
The generated ABI count is now 9. Under Bun `1.4.0` revision `34cbb9a40b4bd1bd767d134a7065e66c2432a676`, the scalar boundary benchmark records zero structural encoding bytes/records for exact/ref and scalar retained calls; its final clean record is `packages/iyon-runtime/bench/PERF-11.3-generated-scalar.json`. Commit `eb3bb92a539e6bbdd0b55c4ab0c26b68b4d5400f` produced native artifact SHA-256 `2c00ec5e0fcf7613902f684602b93beb0e3440999846ec845e254bc6830b4397`, schema BLAKE3 `e533d64e5293b56a70b81e67a9aee34c17cdfd0a9d1199420cfcb263b2d0f470`, and generator BLAKE3 `55f2f1590b18e72152621b4c5272e892f224c5d3b4e4d10e489551129f713903`. With `1,000,000` hot and `10,000` allocation iterations over five repeats, median nanoseconds per call were `runtime_noop 9.605667`, `view_render_ref 23.734166`, `host_render_ref 67.626791`, and `view_text_layout_patch_root 250.3833`.

The final generated ABI, native, and runtime checks passed: `check:tui-abi`; Rust formatting; generator tests; generated ABI layout/delegation tests; 11 native unit tests with `perf-packed-timing`; Bun 1.4 typecheck; and generated host/scalar TUI parity tests. The focused Bun tranche suite passed 6 tests. The benchmark uses the checked default ABI wrapper; the existing `fast-view-abi` feature remains an opt-in timing configuration.
