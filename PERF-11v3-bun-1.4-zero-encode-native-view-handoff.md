...
The committed benchmark `packages/iyon-runtime/bench/PERF-11.1-generated-vertical-slice.json` was captured from clean source revision `fc26d7235677a814417e70b5790e77aed60622ca` under Bun `1.4.0`, revision `34cbb9a40b4bd1bd767d134a7065e66c2432a676`, with `fast-view-abi`, 1,000,000 warm/hot no-op/render-ref/ref-lookup iterations, and 10,000 semantic allocation/patch iterations. Native artifact SHA-256 is `5987e2c7c3db20b5a275cfd3dd8f31bddb582ba526f19bf83ac7d6860f875b4c`; schema BLAKE3 is `7fce882a8b31b7dab23c5515ffde2626513fed07f46366e3d9869a966fe1ccb1`; generator BLAKE3 is `6767bb7dce54c663ecaf7a84446e62ac37ca5f81733789e365918308bcee71b0`. Median nanoseconds per call were: `runtime_noop 9.651708`, `render_ref 15.348875`, `view_ref_for_node_id 38.951708`, `view_spacer_create 169.2791`, `view_text_layout_patch_root 319.2375`, and `view_common_patch_root 225.7416`. The scalar benchmark writes zero structural transport bytes/records and records `structural_encoding_ns = 0`; these numbers are complete end-to-end call timings, not phase-subtracted claims.
