...
The end-to-end test is `packages/iyon-runtime/tests/tui_native_builder.test.ts`; native coverage is in `crates/iyon-native/src/tui/view_abi.rs` and generated ABI delegation/layout coverage is regenerated from the canonical schema. The clean Bun 1.4 benchmark is `packages/iyon-runtime/bench/PERF-11.8-native-builders.json`, captured at source revision `f4016b0100a226513c6a2d93a8c7f9c36c033dc8` with `git_dirty: false`, Bun revision `34cbb9a40b4bd1bd767d134a7065e66c2432a676`, native artifact SHA-256 `1eddb258ef473de9b74a571d70773d863475715738075e4b430df31ad30f28a2`, schema BLAKE3 `823264c7f1539c872782879f296f3782e157960ece5969f64007bb7e5430d801`, and generator BLAKE3 `9c69e5f6b013b2655aa249b00601622b4d569cb6806fb25863e0d71fe93f53de`. With cold new-parent graphs of 20, 200, 2,000, and 10,000 spacer children, the generated route measured `32,212.5 ns`, `110,791.7 ns`, `1,302,861.3 ns`, and `6,328,459 ns`; the pre-materialized V4 control measured `42,950 ns`, `220,962.5 ns`, `2,222,541.7 ns`, and `12,323,292 ns`. The benchmark uses 2 warmups, 3 repeats, and an iteration policy of 10/3/1 for the respective size bands. Routing records centralized small-arity, builder-child, total-node, and depth thresholds. These are full route timings including one host install; they are not phase-subtracted claims.
